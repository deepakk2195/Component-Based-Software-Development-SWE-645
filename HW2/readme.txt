...
1. SWE645.war is the application which contains all the related files for the assignment. 
...
1. Drag and drop the SWE645.war into your tomcat webapps directory under "apache-tomcat-7.0.70\webapps" and restart the tomcat server using IDE or if you are using linux - run command "sudo service tomcat7 restart" using the terminal if you have linux based computer. 
...
http://ec2-34-201-245-46.compute-1.amazonaws.com/swe645assignmet2/index.xhtml
